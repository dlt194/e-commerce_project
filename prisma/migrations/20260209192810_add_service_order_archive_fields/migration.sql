...
INSERT INTO "new_ServiceOrder" ("createdAt", "currency", "deliveredAt", "id", "kickoffCallConfirmed", "kickoffCallConfirmedAt", "requiresKickoffCall", "status", "stripeCheckoutSessionId", "stripePaymentIntentId", "subtotalCents", "totalCents", "updatedAt", "userId") SELECT "createdAt", "currency", "deliveredAt", "id", "kickoffCallConfirmed", "kickoffCallConfirmedAt", "requiresKickoffCall", "status", "stripeCheckoutSessionId", "stripePaymentIntentId", "subtotalCents", "totalCents", "updatedAt", "userId" FROM "ServiceOrder";
